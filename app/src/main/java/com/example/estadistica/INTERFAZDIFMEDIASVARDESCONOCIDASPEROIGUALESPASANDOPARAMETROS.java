...
public class INTERFAZDIFMEDIASVARDESCONOCIDASPEROIGUALESPASANDOPARAMETROS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("I.C para diferencia de medias");
        lienzo.cambia1.setTextColor(Color.RED);
        lienzo.cambia2.setTextColor(Color.RED);
        lienzo.cambia7.setTextColor(Color.RED);
        varianzaM1 = getIntent().getDoubleExtra("varianza1",0);
        varianzaM2 = getIntent().getDoubleExtra("varianza2",0);
        tamMuestral1 = getIntent().getIntExtra("tamMuestra1",0);
        tamMuestral2 = getIntent().getIntExtra("tamMuestra2",0);
        ...
        lienzo.promedioMuestral.setText(String.valueOf(tamMuestral1));
        lienzo.imageCambia3.setImageResource(R.drawable.tlcn2);
        lienzo.tamMuestral.setText(String.valueOf(tamMuestral2));
        lienzo.imageCambia4.setImageResource(R.drawable.scuadrada1);
        lienzo.significancia.setText(String.valueOf(varianzaM1));
        lienzo.imCambia6.setImageResource(R.drawable.scuadrada2);
        lienzo.miu1.setText(String.valueOf(varianzaM2));
