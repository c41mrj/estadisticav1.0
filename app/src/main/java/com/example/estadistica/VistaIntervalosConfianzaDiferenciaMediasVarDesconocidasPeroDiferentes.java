...
public class VistaIntervalosConfianzaDiferenciaMediasVarDesconocidasPeroDiferentes extends AppCompatActivity implements conversiones{

    private ActivityVistaIntervalosConfianzaBinding lienzo;
    private String elementos[] = {"Calcular intervalo de confianza si se desconocen las desviaciones estándar poblacionales pero se sabe que son diferentes","Calcular grado de confianza si se conoce el límite inferior del intervalo de confianza","Calcular grado de confianza si se conoce el límite superior del intervalo de confianza"};
    private ICDIFMEDIASVARDESCONOCIDASPERODIFERENTES teorema;
                        ...
                        .setListener(new AnimatorListenerAdapter() {
                            ...
                            public void onAnimationEnd(Animator animation) {
                                ...
                                try{
                                    ...
                                    teorema = new ICDIFMEDIASVARDESCONOCIDASPERODIFERENTES(varianzaMuestral1,varianzaMuestral2,tamMuestra1,tamMuestra2,diferenciaPromedios,nivelConfianza);
                                    ...
                                    lienzo.paso1IC.setText("Al observar el teorema anteriormente presentado podemos percatarnos de que es necesario calcular un valor para la estimación de los grados de libertad que usaremos posteriormente para buscar valores en tablas.\n\nPara ello se utilizará la siguiente fórmula:");
                                    lienzo.textView107.setText("En éste caso el valor calculado es: " + teorema.getGradosLibertad() + " grados de libertad");

                                    lienzo.imageView31.setImageResource(R.drawable.formulavgradoslibertad);

                                    lienzo.textView108.setText("Una vez que calculamos un valor para la aproximación para v grados de libertad, podemos percatarnos de que es necesario buscar el valor de t(α/2) en  las tablas de la distribución t-student con V = n1 + n2 - 2 = "  + teorema.getGradosLibertad() +
                                    ...
                                    Toast.makeText(VistaIntervalosConfianzaDiferenciaMediasVarDesconocidasPeroDiferentes.this, "Todos los datos son obligatorios", Toast.LENGTH_SHORT).show();
                                }
                            ...
                            .setListener(new AnimatorListenerAdapter() {
                                ...
                                public void onAnimationEnd(Animator animation) {
                                    ...
                                    try{
                                        ...
                                        teorema = new ICDIFMEDIASVARDESCONOCIDASPERODIFERENTES(tamMuestra1,tamMuestra2,varianzaMuestral1,varianzaMuestral2,diferenciaPromedios,limInf,'a');
                                        ...
                                        lienzo.teoremaCoeficienteConfianza1.setImageResource(R.drawable.teoremacoeficienteconfianzadiferenciamediasvardiferentes);
                                        lienzo.imageView6.setImageResource(R.drawable.liminfteoremacoeficienteconfianzadiferenciamediasvardiferentes);
                                        lienzo.determinante.setImageResource(R.drawable.determinanteliminfteoremacoeficienteconfianzadiferenciamediasvardiferentes);
                                        ...
                                        lienzo.textView111.setText("¿Cómo se obtiene el valor de los grados de libertad necesarios para buscar valores en tablas?");
                                        ...
                                        lienzo.layoutSp.setVisibility(View.GONE);
                                        lienzo.textView109.setText("En éste caso el valor calculado para los grados de libertad es: " + teorema.getGradosLibertad());
                                        ...
                                        Toast.makeText(VistaIntervalosConfianzaDiferenciaMediasVarDesconocidasPeroDiferentes.this, "Todos los datos son requeridos para hacer el cálculo", Toast.LENGTH_SHORT).show();
                                    }
                            ...
                            .setListener(new AnimatorListenerAdapter() {
                                ...
                                public void onAnimationEnd(Animator animation) {
                                    ...
                                    try{
                                        ...
                                        teorema = new ICDIFMEDIASVARDESCONOCIDASPERODIFERENTES(tamMuestra1,tamMuestra2,varianzaMuestral1,varianzaMuestral2,diferenciaPromedios,limSup,'b');
                                        lienzo.resultadoIC.setText("Con un límite inferior para el intervalo de confianza de: " + limSup + "\n\nEl coeficiente de confianza calculado es: " + teorema.getCoeficienteConfianza());
                                        ...
                                        lienzo.teoremaCoeficienteConfianza1.setImageResource(R.drawable.teoremacoeficienteconfianzadiferenciamediasvardiferentes);
                                        lienzo.imageView6.setImageResource(R.drawable.limsupteoremacoeficienteconfianzadiferenciamediasvardiferentes);
                                        lienzo.determinante.setImageResource(R.drawable.determinantelimsupteoremacoeficienteconfianzadiferenciamediasvardiferentes);
                                        lienzo.valDeterminante.setText(" = " + teorema.getDeterminante());
                                        ...
                                        lienzo.textView95.setText("Con un limite inferior de: " + limSup + ".\nEl coeficiente de confianza calculado es: " + teorema.getCoeficienteConfianza());
